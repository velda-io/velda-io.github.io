...
const pageConfig = {
  ...
  '/eula': { priority: '0.2', changefreq: 'monthly' },
  '/security': { priority: '0.2', changefreq: 'monthly' },
  '/privacy': { priority: '0.2', changefreq: 'monthly' }
}
  ...
  for (const file of markdownFiles) {
    ...
    const config = pageConfig[urlPath] || 
                  (urlPath.startsWith('/blog/') && urlPath !== '/blog/' ? blogConfig : 
                   pageConfig[urlPath] || { priority: '0.8', changefreq: 'monthly' })
